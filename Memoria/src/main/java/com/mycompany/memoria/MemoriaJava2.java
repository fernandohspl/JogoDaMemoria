 ...
 * @author Thiago
 */
public class MemoriaJava2 extends javax.swing.JFrame  implements ActionListener{

  
 
    int totalLacunaTabela =0; 
    JButton[]  botoes;
    String path = MemoriaJava2.class.getProtectionDomain().getCodeSource().getLocation().getPath();
     ...
     */
    public MemoriaJava2 (int ptotalLacunaTabela, int pLevelMemoria, String level){
     try{ 
   ...
   /* public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                //new MemoriaJava().setVisible(true);
            }
        });
    }*/
